...
test('white overlay must include a visible place name or address',()=>{assert.equal(validateAttendancePhoto({...base,locationText:''},'2026-07-21T10:15:56.000Z',rules).validationCode,'LOCATION_TEXT_MISSING');});
