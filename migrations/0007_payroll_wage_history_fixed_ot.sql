...
CREATE TABLE IF NOT EXISTS ot_requests(
  ...
  employee_confirm_status TEXT NOT NULL DEFAULT 'NOT_REQUIRED' CHECK(employee_confirm_status IN ('NOT_REQUIRED','PENDING','ACCEPTED','DECLINED')),
  ...
  status TEXT NOT NULL DEFAULT 'PENDING_OWNER_FINAL' CHECK(status IN ('PENDING_OWNER_FINAL','PENDING_EMPLOYEE','EMPLOYEE_ACCEPTED','EMPLOYEE_DECLINED','APPROVED','REJECTED','CANCELLED')),
  note TEXT NOT NULL DEFAULT '',
  version INTEGER NOT NULL DEFAULT 1,
  created_at TEXT NOT NULL,
  updated_at TEXT NOT NULL,
