...
export async function bootstrapSheets(env:Env):Promise<void>{
  ...
  const definitions=[
    ...
    [env.SHEET_WEEKLY_PAYROLL,["Pay_Sunday","Week_Start","Employee_ID","Staff_Name","Work_Days","Amount_To_Pay_Baht","Pending_Review_Baht","Status","Version","Base_Wage_Total_Baht","Late_Deduction_Total_Baht","Missing_Punch_Deduction_Total_Baht","OT_Total_Baht","Other_Adjustment_Total_Baht","Net_Pay_Baht","Pending_Review_Count"]],
