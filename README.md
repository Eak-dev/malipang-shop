...
- Automated tests ผ่าน `103` รายการ, live expense text ผ่าน `161/161`, รูปนาฬิกาผ่าน `7/7` และสลิปธนาคาร/วอลเล็ตผ่าน `3/3`
...
- Reconcile/Recovery กระจายงานเป็นกลุ่มละ 5 งานต่อนาที และหน่วง retry เมื่อ Google Sheets ตอบ 429 เพื่อไม่ให้ใช้ retry จนหมดในทันที
...
- `npm run check`: automated tests ผ่าน `103` รายการ (`3` live integration suites ถูก skip โดยค่าเริ่มต้น)
