...
export function payrollPeriodStartThursday(workDate:string):string{
  const d=new Date(`${workDate}T12:00:00+07:00`),daysSinceThursday=(d.getUTCDay()+3)%7;d.setUTCDate(d.getUTCDate()-daysSinceThursday);return d.toISOString().slice(0,10);
}
